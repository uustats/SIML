...
```{block2 type='note'}
The empirical distribution function $\hat F_n$ is the distribution function that puts mass $1/n$ at each data point $x_i$. That is,
$$
...
```{r empiricalDistrFcnExample, echo = TRUE, tidy=FALSE, cache = TRUE, message=FALSE, fig.cap = "Empirical and true distribution function", out.width='80%', fig.asp=.75, fig.align='center'}
...
```{r kidneyData, echo = TRUE, tidy=FALSE, cache = TRUE, message=FALSE, fig.cap = "Kidney function vs age", out.width='80%', fig.asp=.75, fig.align='center'}
